...
export function Puzzle() {
    ...
    document.body.className = "grid justify-center items-start min-h-[100vh] overflow-hidden"
    ...
    const Main_El = document.createElement("main")
        ...
        Main_El.className = "grid place-content-start isolate overflow-hidden max-w-[375px] overflow-hidden"
